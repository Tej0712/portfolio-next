                  ...
                  return (
                    <motion.div
                      ...
                      className={`
                        ...
                        rounded-xl bg-white border p-5 cursor-pointer
                        transition-all duration-300
                        ${
                          isActive
                            ? "border-blue-500 ring-2 ring-blue-300 shadow-xl scale-[1.05]"
                            : "border-slate-200 shadow-sm hover:-translate-y-1 hover:shadow-xl hover:border-blue-300 hover:ring-2 hover:ring-blue-200"
                        }
                      `}
                    >
                      <Icon
