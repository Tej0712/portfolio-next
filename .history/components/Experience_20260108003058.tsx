    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        <motion.h2
          ...
          viewport={{ once: true }}
          className="text-4xl font-bold text-center mb-20 text-blue-900"
        >
          Experience
        </motion.h2>
        ...
        <div className="relative">
          ...
          <div className="space-y-16">
            {experience.map((item, index) => (
              ...
              >
                {/* Timeline Dot */}
                <div className="absolute left-4 top-6 h-4 w-4 rounded-full bg-blue-800 md:left-1/2 md:-translate-x-1/2" />
